...
if ($details) {
    ...
    if ($STUDENT->GenarateCode($email)) {
        ...
        $status = $STUDENT->sendSMS('SLYSC', $STUDENT->phone_number, 'Your account reset code is ' . $resetcode);
        ...
        $from = 'info@slysc.lk'; // give from email address
        ...
        $html .= "<tr><th colspan='3' style='font-size: 18px; padding: 30px 25px 0 25px; color: #fff; text-align: center; background-color: #4184F3;'><h2>SLYSC.lk</h2> </th> </tr>";
