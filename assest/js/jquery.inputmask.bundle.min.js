    ...
    function (e, t, n) {
        ...
        !(function (o) {
                ...
                function r(t, r, o) {
                    ...
                    return (
                        i.prototype.masksCache[u] === a || !0 === n
                            ? ((c = { mask: t, maskToken: i.prototype.analyseMask(t, s, o), validPositions: {}, _buffer: a, buffer: a, tests: {}, metadata: r, maskLength: a }),
            ...
            function l(r, s, c) {
                ...
                function k(e, t) {
                    for (
                        var n, i = e, r = v(), o = h().validPositions[r] || S(0)[0], s = o.alternation !== a ? o.locator[o.alternation].toString().split(",") : [], l = 0;
                        l < i.length &&
                        (!(
                            (n = i[l]).match &&
                                                    ...
                                                    if ("string" != typeof A || -1 !== e.inArray(j.locator[j.alternation].toString(), R)) {
                                                        ...
                                                        if (
                                                            ...
                                                            j.alternation === F.alternation &&
                                                                ...
                                                                -1 === j.na.indexOf(j.locator[j.alternation].toString().split("")[0]) && (j.na = j.na + "," + j.locator[F.alternation].toString().split("")[0]),
                                                                (N = !0),
                                            ...
                                            (t[0].alternation === a
                                                ...
                                                : e.each(t, function (e, t) {
                                                      if ("" !== t.def)
                                                          ...
                                                          else for (var a = 0; a < n.length; a++) t.locator[a] && -1 === n[a].toString().indexOf(t.locator[a]) && (n[a] += "," + t.locator[a]);
                                                  })),
                                        n
                                    );
                                })(g)),
                    ...
                    if (i === a)
                        return (
                            e.setSelectionRange
                                ...
                                : n.selection && n.selection.createRange && (r = (i = 0 - (l = n.selection.createRange()).duplicate().moveStart("character", -e.inputmask._valueGet().length)) + l.text.length),
                            { begin: s(i), end: s(r) }
                        );
                ...
                function V(t, n, r, o, s) {
                    ...
                    else if (!0 !== o && ((h().p = r.begin), !0 !== s)) for (; h().p < u && h().validPositions[h().p] === a; ) h().p++;
                }
                function K(a) {
                    function i(e) {
                        var t,
                ...
                var z,
                    ...
                    ae = {
                        ...
                        focusEvent: function (e) {
                            ...
                            c.showMaskOnFocus && (!c.showMaskOnHover || (c.showMaskOnHover && "" === n)) && (t.inputmask._valueGet() !== A().join("") ? N(t, A(), _(v())) : !1 === te && G(t, _(v()))),
                                !0 === c.positionCaretOnTab && !1 === te && "" !== n && (N(t, A(), G(t)), ae.clickEvent.apply(t, [e, !0])),
                                (z = A().join(""));
                        },
                        ...
                        case "mask":
                            !(function (t) {
                                ...
                                if (
                                    ...
                                    !0 === c.colorMask && K(Y),
                                    d && (Y.hasOwnProperty("inputmode") && ((Y.inputmode = c.inputmode), Y.setAttribute("inputmode", c.inputmode)), "rtfm" === c.androidHack && (!0 !== c.colorMask && K(Y), (Y.type = "password"))),
                                    !0 === i &&
                                ...
                                validator: function (e, t, n, a, i) {
                                    ...
                                    if (r && "24" !== i.hourFormat && i.regex.hrs24.test(e)) {
                                        ...
                                        return (
                                            ...
                                            (o -= 12) < 10 ? ((t.buffer[n] = o.toString()), (t.buffer[n - 1] = "0")) : ((t.buffer[n] = o.toString().charAt(1)), (t.buffer[n - 1] = o.toString().charAt(0))),
